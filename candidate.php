...
<!--End of Tawk.to Script-->
	...
	<body>
		<nav class="navbar navbar-inverse navbar-fixed-top">
			...
			<div class="container-fluid">
				<div class="navbar-header">
                                ...
                                <button type="submit" class="navbar-toggle btn btn-primary" style="border:none;" data-toggle="collapse" data-target="#navbar1">
                    Menu
            </button>
		...
		<!-- updated footer -->
		<nav class="navbar navbar-inverse navbar-fixed-bottom" id="foota">
